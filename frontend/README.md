...
Проект собран на React в функциональном стиле с использованием Хуков. При работе с данными использовался глобальный стейт, так же применялись технологии с подключением контекста и использования Рефов.
